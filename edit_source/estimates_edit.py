...
Location: \\Anaconda3\\envs\\your_caiman_environment\\Lib\\site-packages\\caiman\\source_extraction\\cnmf\\estimates.py
2021-10-25
"""
...
class Estimates(object):
    ...
    def detrend_df_f(self, quantileMin=8, frames_window=500,
        ...
        Returns:
            ...
            data_prct: np.ndarray
                Automatically computes quantile used as dF/F baseline for each component. None if flag_auto == False.
        """
        ...
        self.F_dff, data_prct = detrend_df_f(self.A, self.b, self.C, self.f, self.YrA,
                                  quantileMin=quantileMin,
                                  frames_window=frames_window,
                                  flag_auto=flag_auto, use_fast=use_fast,
                                  detrend_only=detrend_only)
        return self, data_prct
